...
/**
 * A model element representing the very first state. This
 * state usually transitions immediately to the constructor's
 * first state(s).
 * 
 * @author Nels E. Beckman
 */
public class InitialState implements IState, IHasProperties {
