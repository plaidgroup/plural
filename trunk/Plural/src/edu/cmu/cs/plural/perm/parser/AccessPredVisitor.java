...
public interface AccessPredVisitor<T> {	
	T visit(TempPermission perm);
	T visit(Disjunction disj);
	T visit(Conjunction conj);	
	T visit(Withing withing);
	T visit(BinaryExprAP binaryExpr);
	T visit(EqualsExpr equalsExpr);
