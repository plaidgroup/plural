...
/**
 * Represents P_1 + P_2, that is the additive disjunction.
 * 
 * @author Nels Beckman
 * @date Mar 26, 2008
 *
 */
public class Disjunction implements AccessPred {

	private final AccessPred p_1;
	private final AccessPred p_2;
	
	public Disjunction(AccessPred p_1, AccessPred p_2) {
		this.p_1 = p_1;
		this.p_2 = p_2;
	}
	...
	public String toString() {
		return p_1.toString() + " ALT " + p_2.toString();
	}
}
