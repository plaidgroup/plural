...
final public class StateDeclAnnotation implements ICrystalAnnotation {
	...
	public StateDeclAnnotation() {
		crystalAnnotation = new CrystalAnnotation();
	}

	public StateDeclAnnotation(String s) {
	...
	public String getStateName() {
		return this.crystalAnnotation.getObject("name").toString();
	}
