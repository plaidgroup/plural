...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model56_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool170_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool430_B, this.vbool152_uses_F[0]);
			...
			this.vbool178_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool438_B, this.vbool170_uses_F[1]);
			...
			this.vbool131_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool357_B, this.vbool139_uses_F[1]);
			...
			// Message to 'vbool61_uses' from AreEqual factor
			this.vbool61_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool325_B, this.vbool131_uses_F[0]);
			// Message to 'vbool139_uses' from UsesEqualDef factor
			...
			// Message to 'vbool170_uses' from AreEqual factor
			this.vbool170_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool438_B, this.vbool178_uses_F[0]);
			...
			this.vbool438_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool178_uses_F[0], this.vbool170_uses_F[1]);
			...
			// Message to 'vbool152_uses' from AreEqual factor
			this.vbool152_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool430_B, this.vbool170_uses_F[0]);
			...
			this.vbool430_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool152_uses_F[0], this.vbool170_uses_F[0]);
			...
			// Message to 'vbool131_uses' from AreEqual factor
			this.vbool131_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool325_B, this.vbool61_uses_F[2]);
			...
			this.vbool325_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool61_uses_F[2], this.vbool131_uses_F[0]);
			...
			// Message to 'vbool139_uses' from AreEqual factor
			this.vbool139_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool357_B, this.vbool131_uses_F[1]);
			...
			this.vbool357_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool139_uses_F[1], this.vbool131_uses_F[1]);
