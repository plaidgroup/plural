...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model7_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool50_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool294_B, this.vbool6_uses_F[0]);
			...
			this.vbool58_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool310_B, this.vbool50_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool76_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool318_B, this.vbool58_uses_F[1]);
			...
			this.vbool149_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool470_B, this.vbool84_uses_F[1]);
			...
			this.vbool167_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool431_B, this.vbool149_uses_F[1]);
			...
			this.vbool97_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool469_B, this.vbool175_uses_F[1]);
			...
			this.vbool128_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool358_B, this.vbool136_uses_F[0]);
			...
			// Message to 'vbool50_uses' from AreEqual factor
			this.vbool50_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool310_B, this.vbool58_uses_F[0]);
			...
			this.vbool310_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool58_uses_F[0], this.vbool50_uses_F[1]);
			...
			this.vbool6_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool294_B, this.vbool50_uses_F[0]);
			...
			this.vbool294_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool6_uses_F[0], this.vbool50_uses_F[0]);
			...
			// Message to 'vbool136_uses' from AreEqual factor
			this.vbool136_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool358_B, this.vbool128_uses_F[1]);
			...
			this.vbool358_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool136_uses_F[0], this.vbool128_uses_F[1]);
			...
			// Message to 'vbool175_uses' from AreEqual factor
			this.vbool175_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool469_B, this.vbool97_uses_F[1]);
			...
			this.vbool469_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool97_uses_F[1], this.vbool175_uses_F[1]);
			...
			// Message to 'vbool149_uses' from AreEqual factor
			this.vbool149_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool431_B, this.vbool167_uses_F[0]);
			...
			this.vbool431_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool149_uses_F[1], this.vbool167_uses_F[0]);
			...
			// Message to 'vbool84_uses' from AreEqual factor
			this.vbool84_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool470_B, this.vbool149_uses_F[0]);
			...
			this.vbool470_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool84_uses_F[1], this.vbool149_uses_F[0]);
			...
			// Message to 'vbool58_uses' from AreEqual factor
			this.vbool58_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool318_B, this.vbool76_uses_F[0]);
			...
			this.vbool318_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool58_uses_F[1], this.vbool76_uses_F[0]);
