...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model99_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool328_uses_B = new Bernoulli[0];
			this.vBernoulli166 = new Bernoulli(0.01);
			this.vbool328_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli166);
			// Message to 'vbool328' from Random factor
			this.vbool328_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli166);
		}
		...
		{
			this.vbool328_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli166);
			// Message to 'vbool328_marginal' from UsesEqualDef factor
			this.vbool328_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool328_uses_B, this.vbool328_F, this.vbool328_marginal_B);
		}
