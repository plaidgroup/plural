...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model20_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool61_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool309_B, this.vbool53_uses_F[0]);
		...
		public void Update()
		{
			...
			// Message to 'vbool53_uses' from AreEqual factor
			this.vbool53_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool309_B, this.vbool61_uses_F[0]);
			...
			this.vbool309_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool61_uses_F[0], this.vbool53_uses_F[0]);
