...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model95_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool322_uses_B = new Bernoulli[0];
			this.vBernoulli160 = new Bernoulli(0.166666666666667);
			this.vbool322_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli160);
			// Message to 'vbool322' from Random factor
			this.vbool322_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli160);
		}
		...
		{
			this.vbool322_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli160);
			// Message to 'vbool322_marginal' from UsesEqualDef factor
			this.vbool322_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool322_uses_B, this.vbool322_F, this.vbool322_marginal_B);
		}
