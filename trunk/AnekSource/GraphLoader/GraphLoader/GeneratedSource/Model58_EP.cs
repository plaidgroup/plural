...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model58_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool164_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool425_B, this.vbool146_uses_F[0]);
			...
			this.vbool125_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool352_B, this.vbool133_uses_F[1]);
			...
			// Message to 'vbool146_uses' from AreEqual factor
			this.vbool146_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool425_B, this.vbool164_uses_F[0]);
			...
			this.vbool425_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool146_uses_F[0], this.vbool164_uses_F[0]);
			...
			// Message to 'vbool133_uses' from AreEqual factor
			this.vbool133_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool352_B, this.vbool125_uses_F[1]);
			...
			this.vbool352_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool133_uses_F[1], this.vbool125_uses_F[1]);
