...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model16_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool24_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool302_B, this.vbool32_uses_F[0]);
			...
			this.vbool136_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool366_B, this.vbool24_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool120_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool350_B, this.vbool136_uses_F[1]);
			...
			this.vbool97_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool342_B, this.vbool120_uses_F[1]);
			...
			this.vbool175_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool469_B, this.vbool97_uses_F[1]);
			...
			this.vbool167_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool439_B, this.vbool175_uses_F[1]);
			...
			this.vbool84_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool470_B, this.vbool149_uses_F[1]);
			...
			this.vbool76_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool334_B, this.vbool84_uses_F[0]);
			...
			// Message to 'vbool58_uses' from AreEqual factor
			this.vbool58_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool318_B, this.vbool76_uses_F[0]);
			...
			this.vbool128_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool326_B, this.vbool58_uses_F[0]);
			...
			// Message to 'vbool136_uses' from AreEqual factor
			this.vbool136_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool358_B, this.vbool128_uses_F[0]);
			// Message to 'vbool136_uses' from UsesEqualDef factor
			...
			// Message to 'vbool24_uses' from AreEqual factor
			this.vbool24_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool366_B, this.vbool136_uses_F[0]);
			...
			this.vbool366_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool136_uses_F[0], this.vbool24_uses_F[1]);
			...
			this.vbool32_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool302_B, this.vbool24_uses_F[0]);
			...
			this.vbool302_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool32_uses_F[0], this.vbool24_uses_F[0]);
			...
			// Message to 'vbool128_uses' from AreEqual factor
			this.vbool128_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool358_B, this.vbool136_uses_F[2]);
			...
			this.vbool358_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool136_uses_F[2], this.vbool128_uses_F[0]);
			...
			// Message to 'vbool58_uses' from AreEqual factor
			this.vbool58_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool326_B, this.vbool128_uses_F[1]);
			...
			this.vbool326_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool58_uses_F[0], this.vbool128_uses_F[1]);
			...
			// Message to 'vbool76_uses' from AreEqual factor
			this.vbool76_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool318_B, this.vbool58_uses_F[2]);
			...
			this.vbool318_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool58_uses_F[2], this.vbool76_uses_F[0]);
			...
			// Message to 'vbool84_uses' from AreEqual factor
			this.vbool84_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool334_B, this.vbool76_uses_F[1]);
			...
			this.vbool334_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool84_uses_F[0], this.vbool76_uses_F[1]);
			...
			// Message to 'vbool149_uses' from AreEqual factor
			this.vbool149_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool470_B, this.vbool84_uses_F[1]);
			...
			this.vbool470_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool84_uses_F[1], this.vbool149_uses_F[1]);
			...
			// Message to 'vbool175_uses' from AreEqual factor
			this.vbool175_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool439_B, this.vbool167_uses_F[0]);
			...
			this.vbool439_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool175_uses_F[1], this.vbool167_uses_F[0]);
			...
			// Message to 'vbool97_uses' from AreEqual factor
			this.vbool97_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool469_B, this.vbool175_uses_F[0]);
			...
			this.vbool469_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool97_uses_F[1], this.vbool175_uses_F[0]);
			...
			// Message to 'vbool120_uses' from AreEqual factor
			this.vbool120_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool342_B, this.vbool97_uses_F[0]);
			...
			this.vbool342_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool97_uses_F[0], this.vbool120_uses_F[1]);
			...
			// Message to 'vbool136_uses' from AreEqual factor
			this.vbool136_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool350_B, this.vbool120_uses_F[0]);
			...
			this.vbool350_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool136_uses_F[1], this.vbool120_uses_F[0]);
