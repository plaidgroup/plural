...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model8_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool103_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool194_B, this.vbool111_uses_F[2]);
			...
			this.vbool111_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool194_B, this.vbool103_uses_F[0]);
			// Message to 'vbool194' from AreEqual factor
			this.vbool194_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool111_uses_F[2], this.vbool103_uses_F[0]);
			...
			this.vbool420_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool181_uses_F[2], this.vbool163_uses_F[1]);
			...
			this.vbool441_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool181_uses_F[1], this.vbool155_uses_F[2]);
			...
			this.vbool199_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool20_uses_F[1], this.vbool145_uses_F[1]);
			...
			this.vbool200_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool41_uses_F[1], this.vbool20_uses_F[0]);
			...
			this.vbool189_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool46_uses_F[0], this.vbool15_uses_F[0]);
			...
			this.vbool205_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool67_uses_F[0], this.vbool46_uses_F[1]);
