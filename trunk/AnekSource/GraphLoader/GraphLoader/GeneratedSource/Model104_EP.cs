...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model104_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool334_uses_B = new Bernoulli[0];
			this.vBernoulli172 = new Bernoulli(0.01);
			this.vbool334_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli172);
			// Message to 'vbool334' from Random factor
			this.vbool334_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli172);
		}
		...
		{
			this.vbool334_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli172);
			// Message to 'vbool334_marginal' from UsesEqualDef factor
			this.vbool334_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool334_uses_B, this.vbool334_F, this.vbool334_marginal_B);
		}
