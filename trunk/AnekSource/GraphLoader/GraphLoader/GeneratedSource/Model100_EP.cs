...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model100_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool325_uses_B = new Bernoulli[0];
			this.vBernoulli163 = new Bernoulli(0.99);
			this.vbool325_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli163);
			// Message to 'vbool325' from Random factor
			this.vbool325_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli163);
		}
		...
		{
			this.vbool325_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli163);
			// Message to 'vbool325_marginal' from UsesEqualDef factor
			this.vbool325_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool325_uses_B, this.vbool325_F, this.vbool325_marginal_B);
		}
