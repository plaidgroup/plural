...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model26_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool46_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool205_B, this.vbool67_uses_F[0]);
			...
			// Message to 'vbool67_uses' from AreEqual factor
			this.vbool67_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool205_B, this.vbool46_uses_F[0]);
			...
			this.vbool205_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool67_uses_F[0], this.vbool46_uses_F[0]);
