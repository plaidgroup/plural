...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model6_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool49_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool292_B, this.vbool5_uses_F[0]);
			...
			this.vbool57_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool308_B, this.vbool49_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool75_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool316_B, this.vbool57_uses_F[1]);
			...
			this.vbool148_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool466_B, this.vbool83_uses_F[1]);
			...
			this.vbool166_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool429_B, this.vbool148_uses_F[1]);
			...
			this.vbool174_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool437_B, this.vbool166_uses_F[1]);
			...
			this.vbool96_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool465_B, this.vbool174_uses_F[1]);
			...
			this.vbool127_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool356_B, this.vbool135_uses_F[0]);
			...
			// Message to 'vbool57_uses' from AreEqual factor
			this.vbool57_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool324_B, this.vbool127_uses_F[0]);
			// Message to 'vbool57_uses' from UsesEqualDef factor
			...
			// Message to 'vbool49_uses' from AreEqual factor
			this.vbool49_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool308_B, this.vbool57_uses_F[0]);
			...
			this.vbool308_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool57_uses_F[0], this.vbool49_uses_F[1]);
			...
			this.vbool5_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool292_B, this.vbool49_uses_F[0]);
			...
			this.vbool292_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool5_uses_F[0], this.vbool49_uses_F[0]);
			...
			// Message to 'vbool127_uses' from AreEqual factor
			this.vbool127_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool324_B, this.vbool57_uses_F[2]);
			...
			this.vbool324_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool57_uses_F[2], this.vbool127_uses_F[0]);
			...
			// Message to 'vbool135_uses' from AreEqual factor
			this.vbool135_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool356_B, this.vbool127_uses_F[1]);
			...
			this.vbool356_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool135_uses_F[0], this.vbool127_uses_F[1]);
			...
			// Message to 'vbool174_uses' from AreEqual factor
			this.vbool174_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool465_B, this.vbool96_uses_F[1]);
			...
			this.vbool465_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool96_uses_F[1], this.vbool174_uses_F[1]);
			...
			// Message to 'vbool166_uses' from AreEqual factor
			this.vbool166_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool437_B, this.vbool174_uses_F[0]);
			...
			this.vbool437_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool174_uses_F[0], this.vbool166_uses_F[1]);
			...
			// Message to 'vbool148_uses' from AreEqual factor
			this.vbool148_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool429_B, this.vbool166_uses_F[0]);
			...
			this.vbool429_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool148_uses_F[1], this.vbool166_uses_F[0]);
			...
			// Message to 'vbool83_uses' from AreEqual factor
			this.vbool83_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool466_B, this.vbool148_uses_F[0]);
			...
			this.vbool466_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool83_uses_F[1], this.vbool148_uses_F[0]);
			...
			// Message to 'vbool57_uses' from AreEqual factor
			this.vbool57_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool316_B, this.vbool75_uses_F[0]);
			...
			this.vbool316_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool57_uses_F[1], this.vbool75_uses_F[0]);
