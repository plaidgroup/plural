...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model68_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool56_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool306_B, this.vbool48_uses_F[0]);
		}
		...
		public void Update()
		{
			...
			this.vbool165_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool435_B, this.vbool173_uses_F[0]);
			...
			this.vbool126_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool322_B, this.vbool56_uses_F[1]);
			...
			// Message to 'vbool134_uses' from AreEqual factor
			this.vbool134_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool354_B, this.vbool126_uses_F[0]);
			// Message to 'vbool56_uses' from UsesEqualDef factor
			...
			// Message to 'vbool173_uses' from AreEqual factor
			this.vbool173_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool435_B, this.vbool165_uses_F[0]);
			...
			this.vbool435_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool173_uses_F[0], this.vbool165_uses_F[0]);
			...
			// Message to 'vbool126_uses' from AreEqual factor
			this.vbool126_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool354_B, this.vbool134_uses_F[1]);
			...
			this.vbool354_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[1], this.vbool126_uses_F[0]);
			...
			// Message to 'vbool56_uses' from AreEqual factor
			this.vbool56_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool322_B, this.vbool126_uses_F[1]);
			...
			this.vbool322_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[1], this.vbool126_uses_F[1]);
			...
			// Message to 'vbool48_uses' from AreEqual factor
			this.vbool48_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool306_B, this.vbool56_uses_F[2]);
			...
			this.vbool306_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[2], this.vbool48_uses_F[0]);
