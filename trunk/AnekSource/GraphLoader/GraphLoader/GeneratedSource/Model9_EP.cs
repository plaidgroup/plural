...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model9_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool25_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool297_B, this.vbool33_uses_F[0]);
			...
			this.vbool137_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool361_B, this.vbool25_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool85_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool460_B, this.vbool150_uses_F[1]);
			...
			// Message to 'vbool137_uses' from AreEqual factor
			this.vbool137_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool353_B, this.vbool129_uses_F[0]);
			// Message to 'vbool137_uses' from UsesEqualDef factor
			...
			// Message to 'vbool25_uses' from AreEqual factor
			this.vbool25_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool361_B, this.vbool137_uses_F[0]);
			...
			this.vbool361_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool137_uses_F[0], this.vbool25_uses_F[1]);
			...
			this.vbool33_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool297_B, this.vbool25_uses_F[0]);
			...
			this.vbool297_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool33_uses_F[0], this.vbool25_uses_F[0]);
			...
			// Message to 'vbool129_uses' from AreEqual factor
			this.vbool129_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool353_B, this.vbool137_uses_F[2]);
			...
			this.vbool353_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool137_uses_F[2], this.vbool129_uses_F[0]);
			...
			// Message to 'vbool150_uses' from AreEqual factor
			this.vbool150_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool460_B, this.vbool85_uses_F[1]);
			...
			this.vbool460_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool85_uses_F[1], this.vbool150_uses_F[1]);
