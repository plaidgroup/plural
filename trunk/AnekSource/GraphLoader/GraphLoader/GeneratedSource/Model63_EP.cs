...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model63_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool59_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool305_B, this.vbool51_uses_F[0]);
		}
		...
		public void Update()
		{
			...
			this.vbool98_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool337_B, this.vbool121_uses_F[0]);
			...
			this.vbool176_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool459_B, this.vbool98_uses_F[0]);
			...
			this.vbool168_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool434_B, this.vbool176_uses_F[0]);
			...
			this.vbool77_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool329_B, this.vbool85_uses_F[1]);
			...
			// Message to 'vbool59_uses' from AreEqual factor
			this.vbool59_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool313_B, this.vbool77_uses_F[1]);
			...
			this.vbool129_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool321_B, this.vbool59_uses_F[1]);
			...
			// Message to 'vbool77_uses' from AreEqual factor
			this.vbool77_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool313_B, this.vbool59_uses_F[0]);
			...
			this.vbool313_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool59_uses_F[0], this.vbool77_uses_F[1]);
			...
			// Message to 'vbool85_uses' from AreEqual factor
			this.vbool85_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool329_B, this.vbool77_uses_F[0]);
			...
			this.vbool329_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool85_uses_F[1], this.vbool77_uses_F[0]);
			...
			// Message to 'vbool176_uses' from AreEqual factor
			this.vbool176_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool434_B, this.vbool168_uses_F[0]);
			...
			this.vbool434_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool176_uses_F[0], this.vbool168_uses_F[0]);
			...
			// Message to 'vbool98_uses' from AreEqual factor
			this.vbool98_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool459_B, this.vbool176_uses_F[1]);
			...
			this.vbool459_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool98_uses_F[0], this.vbool176_uses_F[1]);
			...
			// Message to 'vbool121_uses' from AreEqual factor
			this.vbool121_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool337_B, this.vbool98_uses_F[1]);
			...
			this.vbool337_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool98_uses_F[1], this.vbool121_uses_F[0]);
			...
			// Message to 'vbool59_uses' from AreEqual factor
			this.vbool59_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool321_B, this.vbool129_uses_F[1]);
			...
			this.vbool321_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool59_uses_F[1], this.vbool129_uses_F[1]);
			...
			// Message to 'vbool51_uses' from AreEqual factor
			this.vbool51_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool305_B, this.vbool59_uses_F[2]);
			...
			this.vbool305_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool59_uses_F[2], this.vbool51_uses_F[0]);
