...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model57_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool171_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool432_B, this.vbool153_uses_F[0]);
			...
			this.vbool132_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool359_B, this.vbool140_uses_F[1]);
			...
			// Message to 'vbool153_uses' from AreEqual factor
			this.vbool153_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool432_B, this.vbool171_uses_F[0]);
			...
			this.vbool432_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool153_uses_F[0], this.vbool171_uses_F[0]);
			...
			// Message to 'vbool140_uses' from AreEqual factor
			this.vbool140_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool359_B, this.vbool132_uses_F[1]);
			...
			this.vbool359_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool140_uses_F[1], this.vbool132_uses_F[1]);
