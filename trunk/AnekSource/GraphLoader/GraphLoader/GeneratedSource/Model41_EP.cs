...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model41_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool95_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool338_B, this.vbool118_uses_F[0]);
			...
			this.vbool74_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool330_B, this.vbool82_uses_F[1]);
			...
			// Message to 'vbool82_uses' from AreEqual factor
			this.vbool82_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool330_B, this.vbool74_uses_F[1]);
			...
			this.vbool330_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool82_uses_F[1], this.vbool74_uses_F[1]);
			...
			// Message to 'vbool118_uses' from AreEqual factor
			this.vbool118_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool338_B, this.vbool95_uses_F[0]);
			...
			this.vbool338_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool95_uses_F[0], this.vbool118_uses_F[0]);
