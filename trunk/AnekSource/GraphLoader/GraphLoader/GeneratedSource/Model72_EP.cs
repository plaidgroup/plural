...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model72_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool296_uses_B = new Bernoulli[0];
			this.vBernoulli139 = new Bernoulli(0.01);
			this.vbool296_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli139);
			// Message to 'vbool296' from Random factor
			this.vbool296_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli139);
		}
		...
		{
			this.vbool296_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli139);
			// Message to 'vbool296_marginal' from UsesEqualDef factor
			this.vbool296_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool296_uses_B, this.vbool296_F, this.vbool296_marginal_B);
		}
