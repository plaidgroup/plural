...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model19_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool60_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool307_B, this.vbool52_uses_F[0]);
		...
		public void Update()
		{
			...
			// Message to 'vbool52_uses' from AreEqual factor
			this.vbool52_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool307_B, this.vbool60_uses_F[0]);
			...
			this.vbool307_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool60_uses_F[0], this.vbool52_uses_F[0]);
