...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model51_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool119_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool348_B, this.vbool135_uses_F[0]);
			...
			// Message to 'vbool135_uses' from AreEqual factor
			this.vbool135_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool348_B, this.vbool119_uses_F[0]);
			...
			this.vbool348_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool135_uses_F[0], this.vbool119_uses_F[0]);
