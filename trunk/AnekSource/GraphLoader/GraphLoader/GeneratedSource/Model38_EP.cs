...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model38_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool100_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool341_B, this.vbool123_uses_F[0]);
			...
			this.vbool79_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool333_B, this.vbool87_uses_F[1]);
			...
			// Message to 'vbool87_uses' from AreEqual factor
			this.vbool87_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool333_B, this.vbool79_uses_F[1]);
			...
			this.vbool333_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool87_uses_F[1], this.vbool79_uses_F[1]);
			...
			// Message to 'vbool123_uses' from AreEqual factor
			this.vbool123_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool341_B, this.vbool100_uses_F[0]);
			...
			this.vbool341_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool100_uses_F[0], this.vbool123_uses_F[0]);
