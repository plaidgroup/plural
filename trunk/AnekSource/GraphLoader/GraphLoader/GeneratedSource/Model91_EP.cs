...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model91_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool323_uses_B = new Bernoulli[0];
			this.vBernoulli161 = new Bernoulli(0.166666666666667);
			this.vbool323_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli161);
			// Message to 'vbool323' from Random factor
			this.vbool323_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli161);
		}
		...
		{
			this.vbool323_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli161);
			// Message to 'vbool323_marginal' from UsesEqualDef factor
			this.vbool323_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool323_uses_B, this.vbool323_F, this.vbool323_marginal_B);
		}
