...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public class Model0_EP : IIterativeProcess
	{
		...
		public void Reset()
		{
			...
			this.vbool51_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool289_B, this.vbool7_uses_F[0]);
			...
			this.vbool59_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool305_B, this.vbool51_uses_F[1]);
		...
		public void Update()
		{
			...
			// Message to 'vbool51_uses' from AreEqual factor
			this.vbool51_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool305_B, this.vbool59_uses_F[0]);
			...
			this.vbool305_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool59_uses_F[0], this.vbool51_uses_F[1]);
			...
			this.vbool7_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool289_B, this.vbool51_uses_F[0]);
			...
			this.vbool289_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool7_uses_F[0], this.vbool51_uses_F[0]);
