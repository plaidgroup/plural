#light
namespace MicrosoftResearch.Infer.FSharp
...
/// Distributions over a float-based domain
 module FloatDistribution =
    ...
    type Gaussian = MicrosoftResearch.Infer.Distributions.Gaussian
    type VectorGaussian = MicrosoftResearch.Infer.Distributions.VectorGaussian //type vector
    type Beta = MicrosoftResearch.Infer.Distributions.Beta
    type Dirichlet = MicrosoftResearch.Infer.Distributions.Dirichlet // type Vector
    type Gamma = MicrosoftResearch.Infer.Distributions.Gamma
    type Wishart = MicrosoftResearch.Infer.Distributions.Wishart
    type Vector = MicrosoftResearch.Infer.Maths.Vector
    type PositiveDefiniteMatrix = MicrosoftResearch.Infer.Maths.PositiveDefiniteMatrix
...
module IntDistribution =
    ...
    type Poisson = MicrosoftResearch.Infer.Distributions.Poisson
...
module BoolDistribution =
    ...
    type Bernoulli = MicrosoftResearch.Infer.Distributions.Bernoulli
