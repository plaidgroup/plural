...
/**
 * This test makes sure that source variable declarations, notably
 * those of parameters, do not cause me to forget the state of
 * other variables, since they are not expressions.
 */
@PassingTest
...
public class SourceVariablesOkay {
