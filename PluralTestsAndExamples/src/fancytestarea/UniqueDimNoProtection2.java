...
public class UniqueDimNoProtection2 {
	...
	void run() {
		...
		// but still do-able.
		@ForcePack("TLOCAL") int IGNOREME;
		
		this.mySharedFile.doSomething(); // ERROR HERE
		this.mySharedFile = new File();
		this.mySharedFile.doSomething();
	}
	
	@Perm(ensures="unique(this!fr)")
	UniqueDimNoProtection2() {
		this.myFile = new File();
		this.mySharedFile = new File();
	}
	...
	static void createThread() {
		UniqueDimNoProtection2 new_thread = new UniqueDimNoProtection2();
