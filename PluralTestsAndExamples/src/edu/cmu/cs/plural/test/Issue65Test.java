...
public class Issue65Test {
	...
	boolean reject_enqueue_requests = false;
	...
	{	
		return elements.size() <= 0; // We should be able to pack here! no Error
	}
}

@SuppressWarnings("serial")
class LinkedList extends java.util.LinkedList<Object> {
