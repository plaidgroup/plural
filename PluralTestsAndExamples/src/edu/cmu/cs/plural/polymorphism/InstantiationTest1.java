...
public final class InstantiationTest1 {
	
	public void foo(@Apply("share") HasParameter hp, @Share Object o) {
		hp.foo(o); // Should work just fine.
	}
}

@Similar("p")
class HasParameter {
	public void foo(@PolyVar("p") Object o) {}
}
