...
@Exact("M")
public final class ArgIsSymmetric1 {

	// ERROR: Unique is not symmetric
	void foo(@Apply("unique") Blah b) {}
	
	// ERROR: FULL is not symmetric
	void foo2(@Apply("full") Blah b) {}	

	// ERROR: M is not symmetric
	void foo3(@Apply("M") Blah b) {}
}
