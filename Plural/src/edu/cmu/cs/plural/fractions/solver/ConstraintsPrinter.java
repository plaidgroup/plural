...
public interface ConstraintsPrinter {
	 ...
	 * @param constraints
	 * @param satisfiable <code>true</code> if known satisfiable,
	 * <code>false</code> if unsatisfiable, and <code>null</code>
	 * if unknown whether constraints are satisfiable or not.
	 * @return
	 */
