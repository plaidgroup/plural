...
public class ImpossibleConstraint extends FractionConstraint {
	...
	public static ImpossibleConstraint INSTANCE = new ImpossibleConstraint();
	
	protected ImpossibleConstraint() {
	}

	/* (non-Javadoc)
	 * @see edu.cmu.cs.plural.fractions.FractionConstraint#dispatch(edu.cmu.cs.plural.fractions.FractionConstraintVisitor)
	 */
	@Override
