...
public class PermAnnotation implements ICrystalAnnotation {
	...
	public PermAnnotation() {
		crystalAnnotation = new CrystalAnnotation();
	}

	public PermAnnotation(String s) {
	...
	public String getEnsures() {
		return this.crystalAnnotation.getObject("ensures").toString();
	}
	
	public String getRequires() {
		return this.crystalAnnotation.getObject("requires").toString();
	}
}
