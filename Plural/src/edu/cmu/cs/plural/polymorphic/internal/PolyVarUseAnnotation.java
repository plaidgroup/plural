...
/**
 * Crystal annotation wrapper for the ATPolyVar annotation, the use site
 * of a polymorphic permission variable.
 * 
 * @author Nels E. Beckman
 * @since Nov 10, 2009
 * @see {@link edu.cmu.cs.plural.annot.PolyVar}
 */
public class PolyVarUseAnnotation implements ICrystalAnnotation {
	...
	/** Returns the name of the polymorphic variable that was mentioned. */
	public String getVariableName() {
		return (String)crystalAnnotation.getObject("value");
	}	
	
	/** Is the permission returned to the calling context? In other words, is it borrowed? */
	public boolean isReturned() {
		return ((Boolean)crystalAnnotation.getObject("returned")).booleanValue();
	}
}