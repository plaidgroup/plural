...
public interface PredicateMerger {
	...
	public interface MergeIntoTuple {
		...
		/**
		 * Releases the parameter with the given name from the given object.
		 * This is to process <code>@Release</code> annotations.
		 * @param var
		 * @param param
		 */
		...
		/**
		 * Merges <b>void</b> into the tuple (which can prove anything...)
		 */
		public void addVoid();
