...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model1_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool52_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool291_B, this.vbool8_uses_F[0]);
			...
			this.vbool60_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool307_B, this.vbool52_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool78_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool315_B, this.vbool60_uses_F[1]);
			...
			this.vbool99_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool463_B, this.vbool177_uses_F[1]);
			...
			// Message to 'vbool52_uses' from AreEqual factor
			this.vbool52_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool307_B, this.vbool60_uses_F[0]);
			...
			this.vbool307_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool60_uses_F[0], this.vbool52_uses_F[1]);
			...
			this.vbool8_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool291_B, this.vbool52_uses_F[0]);
			...
			this.vbool291_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool8_uses_F[0], this.vbool52_uses_F[0]);
			...
			// Message to 'vbool177_uses' from AreEqual factor
			this.vbool177_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool463_B, this.vbool99_uses_F[1]);
			...
			this.vbool463_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool99_uses_F[1], this.vbool177_uses_F[1]);
			...
			// Message to 'vbool60_uses' from AreEqual factor
			this.vbool60_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool315_B, this.vbool78_uses_F[0]);
			...
			this.vbool315_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool60_uses_F[1], this.vbool78_uses_F[0]);
