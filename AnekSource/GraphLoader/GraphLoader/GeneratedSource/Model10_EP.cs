...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model10_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool26_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool299_B, this.vbool34_uses_F[0]);
			...
			this.vbool138_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool363_B, this.vbool26_uses_F[1]);
		...
		public void Update()
		{
			...
			// Message to 'vbool138_uses' from AreEqual factor
			this.vbool138_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool355_B, this.vbool130_uses_F[0]);
			// Message to 'vbool138_uses' from UsesEqualDef factor
			...
			// Message to 'vbool26_uses' from AreEqual factor
			this.vbool26_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool363_B, this.vbool138_uses_F[0]);
			...
			this.vbool363_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool138_uses_F[0], this.vbool26_uses_F[1]);
			...
			this.vbool34_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool299_B, this.vbool26_uses_F[0]);
			...
			this.vbool299_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool34_uses_F[0], this.vbool26_uses_F[0]);
			...
			// Message to 'vbool130_uses' from AreEqual factor
			this.vbool130_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool355_B, this.vbool138_uses_F[2]);
			...
			this.vbool355_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool138_uses_F[2], this.vbool130_uses_F[0]);
