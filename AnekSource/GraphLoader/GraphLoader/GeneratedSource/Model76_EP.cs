...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model76_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool320_uses_B = new Bernoulli[0];
			this.vBernoulli158 = new Bernoulli(0.166666666666667);
			this.vbool320_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli158);
			// Message to 'vbool320' from Random factor
			this.vbool320_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli158);
		}
		...
		{
			this.vbool320_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli158);
			// Message to 'vbool320_marginal' from UsesEqualDef factor
			this.vbool320_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool320_uses_B, this.vbool320_F, this.vbool320_marginal_B);
		}
