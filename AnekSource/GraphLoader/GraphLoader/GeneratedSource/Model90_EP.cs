...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model90_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool324_uses_B = new Bernoulli[0];
			this.vBernoulli162 = new Bernoulli(0.9);
			this.vbool324_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli162);
			// Message to 'vbool324' from Random factor
			this.vbool324_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli162);
		}
		...
		{
			this.vbool324_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli162);
			// Message to 'vbool324_marginal' from UsesEqualDef factor
			this.vbool324_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool324_uses_B, this.vbool324_F, this.vbool324_marginal_B);
		}
