...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model105_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool331_uses_B = new Bernoulli[0];
			this.vBernoulli169 = new Bernoulli(0.99);
			this.vbool331_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli169);
			// Message to 'vbool331' from Random factor
			this.vbool331_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli169);
		}
		...
		{
			this.vbool331_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli169);
			// Message to 'vbool331_marginal' from UsesEqualDef factor
			this.vbool331_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool331_uses_B, this.vbool331_F, this.vbool331_marginal_B);
		}
