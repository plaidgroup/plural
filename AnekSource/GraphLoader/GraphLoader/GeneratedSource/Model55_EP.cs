...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model55_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool169_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool428_B, this.vbool151_uses_F[0]);
			...
			this.vbool130_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool355_B, this.vbool138_uses_F[1]);
			...
			// Message to 'vbool151_uses' from AreEqual factor
			this.vbool151_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool428_B, this.vbool169_uses_F[0]);
			...
			this.vbool428_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool151_uses_F[0], this.vbool169_uses_F[0]);
			...
			// Message to 'vbool138_uses' from AreEqual factor
			this.vbool138_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool355_B, this.vbool130_uses_F[1]);
			...
			this.vbool355_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool138_uses_F[1], this.vbool130_uses_F[1]);
