...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model47_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool123_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool349_B, this.vbool139_uses_F[0]);
			...
			// Message to 'vbool139_uses' from AreEqual factor
			this.vbool139_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool349_B, this.vbool123_uses_F[0]);
			...
			this.vbool349_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool139_uses_F[0], this.vbool123_uses_F[0]);
