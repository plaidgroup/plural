...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model60_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool166_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool429_B, this.vbool148_uses_F[0]);
			...
			this.vbool127_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool356_B, this.vbool135_uses_F[1]);
			...
			// Message to 'vbool148_uses' from AreEqual factor
			this.vbool148_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool429_B, this.vbool166_uses_F[0]);
			...
			this.vbool429_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool148_uses_F[0], this.vbool166_uses_F[0]);
			...
			// Message to 'vbool135_uses' from AreEqual factor
			this.vbool135_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool356_B, this.vbool127_uses_F[1]);
			...
			this.vbool356_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool135_uses_F[1], this.vbool127_uses_F[1]);
