...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model23_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool56_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool306_B, this.vbool48_uses_F[0]);
		...
		public void Update()
		{
			...
			// Message to 'vbool48_uses' from AreEqual factor
			this.vbool48_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool306_B, this.vbool56_uses_F[0]);
			...
			this.vbool306_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[0], this.vbool48_uses_F[0]);
