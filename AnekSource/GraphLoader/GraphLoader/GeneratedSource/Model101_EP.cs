...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model101_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool335_uses_B = new Bernoulli[0];
			this.vBernoulli173 = new Bernoulli(0.01);
			this.vbool335_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli173);
			// Message to 'vbool335' from Random factor
			this.vbool335_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli173);
		}
		...
		{
			this.vbool335_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli173);
			// Message to 'vbool335_marginal' from UsesEqualDef factor
			this.vbool335_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool335_uses_B, this.vbool335_F, this.vbool335_marginal_B);
		}
