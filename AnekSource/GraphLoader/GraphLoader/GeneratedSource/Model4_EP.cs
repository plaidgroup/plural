...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model4_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool47_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool288_B, this.vbool3_uses_F[0]);
			...
			this.vbool55_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool304_B, this.vbool47_uses_F[1]);
		...
		public void Update()
		{
			...
			// Message to 'vbool47_uses' from AreEqual factor
			this.vbool47_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool304_B, this.vbool55_uses_F[0]);
			...
			this.vbool304_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool55_uses_F[0], this.vbool47_uses_F[1]);
			...
			this.vbool3_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool288_B, this.vbool47_uses_F[0]);
			...
			this.vbool288_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool3_uses_F[0], this.vbool47_uses_F[0]);
