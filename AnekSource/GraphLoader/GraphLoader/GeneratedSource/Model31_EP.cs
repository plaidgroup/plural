...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model31_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool81_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool328_B, this.vbool73_uses_F[0]);
			...
			this.vbool117_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool336_B, this.vbool94_uses_F[1]);
			...
			// Message to 'vbool94_uses' from AreEqual factor
			this.vbool94_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool336_B, this.vbool117_uses_F[1]);
			...
			this.vbool336_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool94_uses_F[1], this.vbool117_uses_F[1]);
			...
			// Message to 'vbool73_uses' from AreEqual factor
			this.vbool73_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool328_B, this.vbool81_uses_F[0]);
			...
			this.vbool328_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool81_uses_F[0], this.vbool73_uses_F[0]);
