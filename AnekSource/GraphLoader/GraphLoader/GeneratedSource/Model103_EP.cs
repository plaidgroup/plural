...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model103_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool333_uses_B = new Bernoulli[0];
			this.vBernoulli171 = new Bernoulli(0.01);
			this.vbool333_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli171);
			// Message to 'vbool333' from Random factor
			this.vbool333_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli171);
		}
		...
		{
			this.vbool333_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli171);
			// Message to 'vbool333_marginal' from UsesEqualDef factor
			this.vbool333_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool333_uses_B, this.vbool333_F, this.vbool333_marginal_B);
		}
