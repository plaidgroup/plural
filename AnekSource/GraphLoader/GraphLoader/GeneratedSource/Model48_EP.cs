...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model48_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool124_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool351_B, this.vbool140_uses_F[0]);
			...
			// Message to 'vbool140_uses' from AreEqual factor
			this.vbool140_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool351_B, this.vbool124_uses_F[0]);
			...
			this.vbool351_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool140_uses_F[0], this.vbool124_uses_F[0]);
