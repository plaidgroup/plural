...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model33_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool83_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool332_B, this.vbool75_uses_F[0]);
			...
			this.vbool119_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool340_B, this.vbool96_uses_F[1]);
			...
			// Message to 'vbool96_uses' from AreEqual factor
			this.vbool96_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool340_B, this.vbool119_uses_F[1]);
			...
			this.vbool340_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool96_uses_F[1], this.vbool119_uses_F[1]);
			...
			// Message to 'vbool75_uses' from AreEqual factor
			this.vbool75_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool332_B, this.vbool83_uses_F[0]);
			...
			this.vbool332_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool83_uses_F[0], this.vbool75_uses_F[0]);
