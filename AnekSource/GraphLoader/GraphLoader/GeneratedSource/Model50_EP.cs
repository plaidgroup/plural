...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model50_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool118_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool346_B, this.vbool134_uses_F[0]);
			...
			// Message to 'vbool134_uses' from AreEqual factor
			this.vbool134_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool346_B, this.vbool118_uses_F[0]);
			...
			this.vbool346_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[0], this.vbool118_uses_F[0]);
