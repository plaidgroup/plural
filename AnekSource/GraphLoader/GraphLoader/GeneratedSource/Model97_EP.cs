...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model97_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool326_uses_B = new Bernoulli[0];
			this.vBernoulli164 = new Bernoulli(0.01);
			this.vbool326_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli164);
			// Message to 'vbool326' from Random factor
			this.vbool326_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli164);
		}
		...
		{
			this.vbool326_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli164);
			// Message to 'vbool326_marginal' from UsesEqualDef factor
			this.vbool326_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool326_uses_B, this.vbool326_F, this.vbool326_marginal_B);
		}
