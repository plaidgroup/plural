...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model79_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool329_uses_B = new Bernoulli[0];
			this.vBernoulli167 = new Bernoulli(0.01);
			this.vbool329_F = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli167);
			// Message to 'vbool329' from Random factor
			this.vbool329_F = UnaryOp<bool>.RandomAverageConditional<Bernoulli>(this.vBernoulli167);
		}
		...
		{
			this.vbool329_marginal_B = ArrayHelper.MakeUniform<Bernoulli>(vBernoulli167);
			// Message to 'vbool329_marginal' from UsesEqualDef factor
			this.vbool329_marginal_B = UsesEqualDefOp.MarginalAverageConditional<Bernoulli>(this.vbool329_uses_B, this.vbool329_F, this.vbool329_marginal_B);
		}
