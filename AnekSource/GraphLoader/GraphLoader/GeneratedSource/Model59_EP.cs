...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model59_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool22_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool298_B, this.vbool30_uses_F[0]);
			...
			this.vbool134_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool362_B, this.vbool22_uses_F[0]);
		}
		...
		public void Update()
		{
			...
			this.vbool74_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool314_B, this.vbool56_uses_F[0]);
			...
			this.vbool82_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool330_B, this.vbool74_uses_F[0]);
			...
			this.vbool147_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool462_B, this.vbool82_uses_F[0]);
			...
			this.vbool165_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool427_B, this.vbool147_uses_F[0]);
			...
			this.vbool173_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool435_B, this.vbool165_uses_F[1]);
			...
			this.vbool95_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool461_B, this.vbool173_uses_F[1]);
			...
			this.vbool118_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool338_B, this.vbool95_uses_F[1]);
			...
			// Message to 'vbool134_uses' from AreEqual factor
			this.vbool134_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool346_B, this.vbool118_uses_F[1]);
			...
			this.vbool126_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool354_B, this.vbool134_uses_F[1]);
			...
			// Message to 'vbool56_uses' from AreEqual factor
			this.vbool56_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool322_B, this.vbool126_uses_F[0]);
			// Message to 'vbool134_uses' from UsesEqualDef factor
			...
			// Message to 'vbool118_uses' from AreEqual factor
			this.vbool118_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool346_B, this.vbool134_uses_F[0]);
			...
			this.vbool346_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[0], this.vbool118_uses_F[1]);
			...
			// Message to 'vbool95_uses' from AreEqual factor
			this.vbool95_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool338_B, this.vbool118_uses_F[0]);
			...
			this.vbool338_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool95_uses_F[1], this.vbool118_uses_F[0]);
			...
			// Message to 'vbool173_uses' from AreEqual factor
			this.vbool173_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool461_B, this.vbool95_uses_F[0]);
			...
			this.vbool461_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool95_uses_F[0], this.vbool173_uses_F[1]);
			...
			// Message to 'vbool165_uses' from AreEqual factor
			this.vbool165_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool435_B, this.vbool173_uses_F[0]);
			...
			this.vbool435_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool173_uses_F[0], this.vbool165_uses_F[1]);
			...
			// Message to 'vbool147_uses' from AreEqual factor
			this.vbool147_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool427_B, this.vbool165_uses_F[0]);
			...
			this.vbool427_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool147_uses_F[0], this.vbool165_uses_F[0]);
			...
			// Message to 'vbool82_uses' from AreEqual factor
			this.vbool82_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool462_B, this.vbool147_uses_F[1]);
			...
			this.vbool462_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool82_uses_F[0], this.vbool147_uses_F[1]);
			...
			// Message to 'vbool74_uses' from AreEqual factor
			this.vbool74_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool330_B, this.vbool82_uses_F[1]);
			...
			this.vbool330_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool82_uses_F[1], this.vbool74_uses_F[0]);
			...
			// Message to 'vbool56_uses' from AreEqual factor
			this.vbool56_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool314_B, this.vbool74_uses_F[1]);
			...
			this.vbool314_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[0], this.vbool74_uses_F[1]);
			...
			// Message to 'vbool126_uses' from AreEqual factor
			this.vbool126_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool322_B, this.vbool56_uses_F[2]);
			...
			this.vbool322_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[2], this.vbool126_uses_F[0]);
			...
			// Message to 'vbool134_uses' from AreEqual factor
			this.vbool134_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool354_B, this.vbool126_uses_F[1]);
			...
			this.vbool354_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[1], this.vbool126_uses_F[1]);
			...
			// Message to 'vbool22_uses' from AreEqual factor
			this.vbool22_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool362_B, this.vbool134_uses_F[2]);
			...
			this.vbool362_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[2], this.vbool22_uses_F[0]);
			...
			this.vbool30_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool298_B, this.vbool22_uses_F[1]);
			...
			this.vbool298_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool30_uses_F[0], this.vbool22_uses_F[1]);
