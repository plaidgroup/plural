...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model5_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool48_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool290_B, this.vbool4_uses_F[0]);
			...
			this.vbool56_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool306_B, this.vbool48_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool74_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool314_B, this.vbool56_uses_F[1]);
			...
			this.vbool95_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool461_B, this.vbool173_uses_F[1]);
			...
			// Message to 'vbool48_uses' from AreEqual factor
			this.vbool48_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool306_B, this.vbool56_uses_F[0]);
			...
			this.vbool306_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[0], this.vbool48_uses_F[1]);
			...
			this.vbool4_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool290_B, this.vbool48_uses_F[0]);
			...
			this.vbool290_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool4_uses_F[0], this.vbool48_uses_F[0]);
			...
			// Message to 'vbool173_uses' from AreEqual factor
			this.vbool173_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool461_B, this.vbool95_uses_F[1]);
			...
			this.vbool461_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool95_uses_F[1], this.vbool173_uses_F[1]);
			...
			// Message to 'vbool56_uses' from AreEqual factor
			this.vbool56_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool314_B, this.vbool74_uses_F[0]);
			...
			this.vbool314_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool56_uses_F[1], this.vbool74_uses_F[0]);
