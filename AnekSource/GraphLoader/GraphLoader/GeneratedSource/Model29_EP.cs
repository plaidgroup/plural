...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model29_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool87_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool333_B, this.vbool79_uses_F[0]);
			...
			this.vbool152_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool468_B, this.vbool87_uses_F[1]);
			...
			this.vbool170_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool430_B, this.vbool152_uses_F[1]);
			...
			this.vbool123_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool341_B, this.vbool100_uses_F[1]);
			...
			this.vbool131_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool357_B, this.vbool139_uses_F[0]);
			...
			// Message to 'vbool139_uses' from AreEqual factor
			this.vbool139_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool357_B, this.vbool131_uses_F[1]);
			...
			this.vbool357_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool139_uses_F[0], this.vbool131_uses_F[1]);
			...
			// Message to 'vbool100_uses' from AreEqual factor
			this.vbool100_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool341_B, this.vbool123_uses_F[1]);
			...
			this.vbool341_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool100_uses_F[1], this.vbool123_uses_F[1]);
			...
			// Message to 'vbool152_uses' from AreEqual factor
			this.vbool152_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool430_B, this.vbool170_uses_F[0]);
			...
			this.vbool430_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool152_uses_F[1], this.vbool170_uses_F[0]);
			...
			// Message to 'vbool87_uses' from AreEqual factor
			this.vbool87_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool468_B, this.vbool152_uses_F[0]);
			...
			this.vbool468_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool87_uses_F[1], this.vbool152_uses_F[0]);
			...
			// Message to 'vbool79_uses' from AreEqual factor
			this.vbool79_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool333_B, this.vbool87_uses_F[0]);
			...
			this.vbool333_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool87_uses_F[0], this.vbool79_uses_F[0]);
