...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model49_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool117_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool344_B, this.vbool133_uses_F[0]);
			...
			// Message to 'vbool133_uses' from AreEqual factor
			this.vbool133_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool344_B, this.vbool117_uses_F[0]);
			...
			this.vbool344_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool133_uses_F[0], this.vbool117_uses_F[0]);
