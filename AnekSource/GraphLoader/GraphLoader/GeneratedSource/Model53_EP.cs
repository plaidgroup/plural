...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model53_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			// Message to 'vbool145_uses' from AreEqual factor
			this.vbool145_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool199_B, this.vbool20_uses_F[0]);
			...
			// Message to 'vbool20_uses' from AreEqual factor
			this.vbool20_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool199_B, this.vbool145_uses_F[0]);
			...
			this.vbool199_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool20_uses_F[0], this.vbool145_uses_F[0]);
