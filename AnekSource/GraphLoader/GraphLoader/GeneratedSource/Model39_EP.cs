...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model39_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool101_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool343_B, this.vbool124_uses_F[0]);
			...
			this.vbool80_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool335_B, this.vbool88_uses_F[1]);
			...
			// Message to 'vbool88_uses' from AreEqual factor
			this.vbool88_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool335_B, this.vbool80_uses_F[1]);
			...
			this.vbool335_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool88_uses_F[1], this.vbool80_uses_F[1]);
			...
			// Message to 'vbool124_uses' from AreEqual factor
			this.vbool124_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool343_B, this.vbool101_uses_F[0]);
			...
			this.vbool343_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool101_uses_F[0], this.vbool124_uses_F[0]);
