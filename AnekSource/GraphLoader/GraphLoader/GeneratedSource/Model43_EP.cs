...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model43_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool97_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool342_B, this.vbool120_uses_F[0]);
			...
			this.vbool76_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool334_B, this.vbool84_uses_F[1]);
			...
			// Message to 'vbool84_uses' from AreEqual factor
			this.vbool84_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool334_B, this.vbool76_uses_F[1]);
			...
			this.vbool334_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool84_uses_F[1], this.vbool76_uses_F[1]);
			...
			// Message to 'vbool120_uses' from AreEqual factor
			this.vbool120_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool342_B, this.vbool97_uses_F[0]);
			...
			this.vbool342_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool97_uses_F[0], this.vbool120_uses_F[0]);
