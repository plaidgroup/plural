...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model52_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool120_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool350_B, this.vbool136_uses_F[0]);
			...
			// Message to 'vbool136_uses' from AreEqual factor
			this.vbool136_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool350_B, this.vbool120_uses_F[0]);
			...
			this.vbool350_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool136_uses_F[0], this.vbool120_uses_F[0]);
