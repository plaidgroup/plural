...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model2_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool53_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool293_B, this.vbool9_uses_F[0]);
			...
			this.vbool61_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool309_B, this.vbool53_uses_F[1]);
		...
		public void Update()
		{
			...
			this.vbool79_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool317_B, this.vbool61_uses_F[1]);
			...
			this.vbool100_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool467_B, this.vbool178_uses_F[1]);
			...
			// Message to 'vbool53_uses' from AreEqual factor
			this.vbool53_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool309_B, this.vbool61_uses_F[0]);
			...
			this.vbool309_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool61_uses_F[0], this.vbool53_uses_F[1]);
			...
			this.vbool9_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool293_B, this.vbool53_uses_F[0]);
			...
			this.vbool293_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool9_uses_F[0], this.vbool53_uses_F[0]);
			...
			// Message to 'vbool178_uses' from AreEqual factor
			this.vbool178_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool467_B, this.vbool100_uses_F[1]);
			...
			this.vbool467_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool100_uses_F[1], this.vbool178_uses_F[1]);
			...
			// Message to 'vbool61_uses' from AreEqual factor
			this.vbool61_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool317_B, this.vbool79_uses_F[0]);
			...
			this.vbool317_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool61_uses_F[1], this.vbool79_uses_F[0]);
