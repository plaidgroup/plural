...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model3_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool54_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool295_B, this.vbool10_uses_F[0]);
			...
			this.vbool62_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool311_B, this.vbool54_uses_F[1]);
		...
		public void Update()
		{
			...
			// Message to 'vbool54_uses' from AreEqual factor
			this.vbool54_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool311_B, this.vbool62_uses_F[0]);
			...
			this.vbool311_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool62_uses_F[0], this.vbool54_uses_F[1]);
			...
			this.vbool10_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool295_B, this.vbool54_uses_F[0]);
			...
			this.vbool295_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool10_uses_F[0], this.vbool54_uses_F[0]);
