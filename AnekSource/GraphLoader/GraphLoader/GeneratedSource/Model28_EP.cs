...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model28_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool86_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool331_B, this.vbool78_uses_F[0]);
			...
			this.vbool151_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool464_B, this.vbool86_uses_F[1]);
			...
			this.vbool169_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool428_B, this.vbool151_uses_F[1]);
			...
			this.vbool177_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool436_B, this.vbool169_uses_F[1]);
			...
			this.vbool122_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool339_B, this.vbool99_uses_F[1]);
			...
			// Message to 'vbool138_uses' from AreEqual factor
			this.vbool138_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool347_B, this.vbool122_uses_F[0]);
			...
			this.vbool130_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool355_B, this.vbool138_uses_F[0]);
			...
			// Message to 'vbool60_uses' from AreEqual factor
			this.vbool60_uses_B[2] = BooleanAreEqualOp.AAverageConditional(this.vbool323_B, this.vbool130_uses_F[0]);
			// Message to 'vbool60_uses' from UsesEqualDef factor
			...
			// Message to 'vbool130_uses' from AreEqual factor
			this.vbool130_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool323_B, this.vbool60_uses_F[2]);
			...
			this.vbool323_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool60_uses_F[2], this.vbool130_uses_F[0]);
			...
			// Message to 'vbool138_uses' from AreEqual factor
			this.vbool138_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool355_B, this.vbool130_uses_F[1]);
			...
			this.vbool355_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool138_uses_F[0], this.vbool130_uses_F[1]);
			...
			// Message to 'vbool122_uses' from AreEqual factor
			this.vbool122_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool347_B, this.vbool138_uses_F[1]);
			...
			this.vbool347_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool138_uses_F[1], this.vbool122_uses_F[0]);
			...
			// Message to 'vbool99_uses' from AreEqual factor
			this.vbool99_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool339_B, this.vbool122_uses_F[1]);
			...
			this.vbool339_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool99_uses_F[1], this.vbool122_uses_F[1]);
			...
			// Message to 'vbool169_uses' from AreEqual factor
			this.vbool169_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool436_B, this.vbool177_uses_F[0]);
			...
			this.vbool436_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool177_uses_F[0], this.vbool169_uses_F[1]);
			...
			// Message to 'vbool151_uses' from AreEqual factor
			this.vbool151_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool428_B, this.vbool169_uses_F[0]);
			...
			this.vbool428_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool151_uses_F[1], this.vbool169_uses_F[0]);
			...
			// Message to 'vbool86_uses' from AreEqual factor
			this.vbool86_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool464_B, this.vbool151_uses_F[0]);
			...
			this.vbool464_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool86_uses_F[1], this.vbool151_uses_F[0]);
			...
			// Message to 'vbool78_uses' from AreEqual factor
			this.vbool78_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool331_B, this.vbool86_uses_F[0]);
			...
			this.vbool331_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool86_uses_F[0], this.vbool78_uses_F[0]);
