...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model37_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool99_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool339_B, this.vbool122_uses_F[0]);
			...
			this.vbool78_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool331_B, this.vbool86_uses_F[1]);
			...
			// Message to 'vbool86_uses' from AreEqual factor
			this.vbool86_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool331_B, this.vbool78_uses_F[1]);
			...
			this.vbool331_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool86_uses_F[1], this.vbool78_uses_F[1]);
			...
			// Message to 'vbool122_uses' from AreEqual factor
			this.vbool122_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool339_B, this.vbool99_uses_F[0]);
			...
			this.vbool339_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool99_uses_F[0], this.vbool122_uses_F[0]);
