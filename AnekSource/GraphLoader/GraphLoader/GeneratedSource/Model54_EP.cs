...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model54_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool168_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool426_B, this.vbool150_uses_F[0]);
			...
			this.vbool129_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool353_B, this.vbool137_uses_F[1]);
			...
			// Message to 'vbool150_uses' from AreEqual factor
			this.vbool150_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool426_B, this.vbool168_uses_F[0]);
			...
			this.vbool426_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool150_uses_F[0], this.vbool168_uses_F[0]);
			...
			// Message to 'vbool137_uses' from AreEqual factor
			this.vbool137_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool353_B, this.vbool129_uses_F[1]);
			...
			this.vbool353_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool137_uses_F[1], this.vbool129_uses_F[1]);
