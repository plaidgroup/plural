...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model45_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool121_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool345_B, this.vbool137_uses_F[0]);
			...
			// Message to 'vbool137_uses' from AreEqual factor
			this.vbool137_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool345_B, this.vbool121_uses_F[0]);
			...
			this.vbool345_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool137_uses_F[0], this.vbool121_uses_F[0]);
