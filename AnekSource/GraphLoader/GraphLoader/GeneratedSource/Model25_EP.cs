...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model25_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool58_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool310_B, this.vbool50_uses_F[0]);
		...
		public void Update()
		{
			...
			// Message to 'vbool50_uses' from AreEqual factor
			this.vbool50_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool310_B, this.vbool58_uses_F[0]);
			...
			this.vbool310_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool58_uses_F[0], this.vbool50_uses_F[0]);
