...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model27_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool85_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool329_B, this.vbool77_uses_F[0]);
			...
			this.vbool121_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool337_B, this.vbool98_uses_F[1]);
			...
			// Message to 'vbool98_uses' from AreEqual factor
			this.vbool98_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool337_B, this.vbool121_uses_F[1]);
			...
			this.vbool337_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool98_uses_F[1], this.vbool121_uses_F[1]);
			...
			// Message to 'vbool77_uses' from AreEqual factor
			this.vbool77_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool329_B, this.vbool85_uses_F[0]);
			...
			this.vbool329_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool85_uses_F[0], this.vbool77_uses_F[0]);
