...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model32_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Update()
		{
			...
			this.vbool82_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool330_B, this.vbool74_uses_F[0]);
			...
			this.vbool147_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool462_B, this.vbool82_uses_F[1]);
			...
			this.vbool165_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool427_B, this.vbool147_uses_F[1]);
			...
			this.vbool118_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool338_B, this.vbool95_uses_F[1]);
			...
			this.vbool126_uses_B[1] = BooleanAreEqualOp.BAverageConditional(this.vbool354_B, this.vbool134_uses_F[0]);
			...
			// Message to 'vbool134_uses' from AreEqual factor
			this.vbool134_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool354_B, this.vbool126_uses_F[1]);
			...
			this.vbool354_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool134_uses_F[0], this.vbool126_uses_F[1]);
			...
			// Message to 'vbool95_uses' from AreEqual factor
			this.vbool95_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool338_B, this.vbool118_uses_F[1]);
			...
			this.vbool338_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool95_uses_F[1], this.vbool118_uses_F[1]);
			...
			// Message to 'vbool147_uses' from AreEqual factor
			this.vbool147_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool427_B, this.vbool165_uses_F[0]);
			...
			this.vbool427_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool147_uses_F[1], this.vbool165_uses_F[0]);
			...
			// Message to 'vbool82_uses' from AreEqual factor
			this.vbool82_uses_B[1] = BooleanAreEqualOp.AAverageConditional(this.vbool462_B, this.vbool147_uses_F[0]);
			...
			this.vbool462_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool82_uses_F[1], this.vbool147_uses_F[0]);
			...
			// Message to 'vbool74_uses' from AreEqual factor
			this.vbool74_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool330_B, this.vbool82_uses_F[0]);
			...
			this.vbool330_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool82_uses_F[0], this.vbool74_uses_F[0]);
