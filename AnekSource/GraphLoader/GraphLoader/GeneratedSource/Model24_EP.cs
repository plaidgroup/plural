...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	/// </remarks>
	public class Model24_EP : IIterativeProcess
	{
		#region Fields
		...
		public void Reset()
		{
			...
			this.vbool57_uses_B[0] = BooleanAreEqualOp.AAverageConditional(this.vbool308_B, this.vbool49_uses_F[0]);
		...
		public void Update()
		{
			...
			// Message to 'vbool49_uses' from AreEqual factor
			this.vbool49_uses_B[0] = BooleanAreEqualOp.BAverageConditional(this.vbool308_B, this.vbool57_uses_F[0]);
			...
			this.vbool308_F = BooleanAreEqualOp.AreEqualAverageConditional(this.vbool57_uses_F[0], this.vbool49_uses_F[0]);
